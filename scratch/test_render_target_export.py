    ...
    try:
        ...
        if capture_actor:
            ...
            if comp:
                ...
                # Pass file_name WITHOUT .png extension!
                unreal.RenderingLibrary.export_render_target(None, rt, target_dir, "ue_screenshot")
                f.write("Exported render target with file_name='ue_screenshot' successfully!\\n")
...
print("Executing Offscreen RenderTarget Export...")
